    ...
    <div className='border-t pt-10 transition-opacity ease-in-out duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>Clara is your go-to destination for exquistite Indian Kurtis that blend traditional crafstmanship with contemporary fashion. Discover our
          wide range of elegant and comfortable kurtis designed to make you stand out on any occasion.</p>
          <p>Clara is your go-to destination for exquistite Indian Kurtis that blend traditional crafstmanship with contemporary fashion. Discover our
          wide range of elegant and comfortable kurtis designed to make you stand out on any occasion.</p>
        </div>
      </div>
